...
<div id="second_box">
	...
	<div>
		...
		<p class="showdetail btnn" news_id="<?=$value['news_id'];?>">详情</p>
	</div>
	<?php	
		}
	?>
...
<div id="third_box">
	<div id="news_content">
		<p id="join_detail" class=" btnn">我要参加</p>
		<i>标题</i>
		<img src="img/123.jpg">
		<ul>
			<li>所需人数：</li>
		...
		<form id="join_form">
			...
			<br>
			<input type="button" value="保存" id="save_join" class="join_btn btnn">
			<input type="reset" value="取消" class="join_btn btnn">
		</form>
	</div>
	</div>
