...
<div class="body2_box" id="body2_box">
    ...
    <div class="content_box2" id="content_box2">
        ...
        <?php 
        echo '<img src="'.$content['imgvals'].'" class="img22" id="img22">';
        ?>
        </div>
...
<img src="./img/14.jpg" class="img31" id="img31" alt="">
...
$content=$result->fetch_array(MYSQLI_ASSOC);
 ?>
    <div class="content_img_box3" id="content_img_box3">
     <?php 
    echo '<img src="'.$content['imgvals'].'" class="img32" id="img32">';
    ?>
    </div>
...
<img src="./img/15.jpg" class="img41" id="img41" alt="">
...
$content=$result->fetch_array(MYSQLI_ASSOC);
 ?>
    <div class="content_img_box4" id="content_img_box4">
     <?php 
    echo '<img src="'.$content['imgvals'].'" class="img42" id="img42">';
    ?>
    </div>
